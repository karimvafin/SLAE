...
#include <iostream>
#include "project/solvers/SimpleIteration.hpp"
#include "project/utility/overloads.hpp"

TEST(SIMPLE_ITERATION, SIMPLE_ITERATION_HI)
{
    /*
     * 2 0 0
     * 0 1 0
    ...
    std::vector<double> sol = SimpleIteration(matrix, b, initialState, 0.15, 0.0001);
